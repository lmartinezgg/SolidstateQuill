...
const contractABI = require("../artifacts/contracts/Solidstatequill.sol/Solidstatequill.json").abi;

program
    .name("solidstatequill-cli")
    .description("CLI tool for Solidstatequill smart contract")
    .version("1.0.0");
